...
for MODEL_NAME in "${MODEL_NAMES[@]}"; do
    ...
    for class_name in $CLASS_NAMES; do
        ...
        echo "------------------------------------------------------------------"
        echo "Plotting attention maps for config class: $class_name"
        ...
        pid=$!
        wait $pid
        echo "Finished Plotting attention maps for config class: $class_name"
